      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="modal-footer ">
            <button type="button" class="btn btn-success btn-lg" style="width: 100%;" id="new-data" onclick={add_deh} data-loading-text="Please Wait..."><span class="glyphicon glyphicon-ok-sign"></span> Input</button>
          </div>
        </div>
      <!-- /.modal-content -->
    </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="modal-footer ">
            <button type="button" class="btn btn-warning btn-lg" style="width: 100%;" id="update-data" data-loading-text="Please Wait..."><span class="glyphicon glyphicon-ok-sign"></span> Update</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
    ...
    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer ">
            <button type="button" class="btn btn-success" id="delete-data" data-loading-text="Please Wait..."><span class="glyphicon glyphicon-ok-sign"></span> Yes</button>
